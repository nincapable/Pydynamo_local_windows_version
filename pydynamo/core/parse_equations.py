"""Functions used to read and parse equations written with a dynamo syntax. Retrive equation type (constant, update, initialisation) and arguments (variables, constants, indices)."""

import ast
import astunparse
import re

# Functions that are note considered as special functions
math_fun = {'sqrt', 'exp', 'log'}
not_parse_fun = math_fun.union(__builtins__)
